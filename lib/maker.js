...
function run(){
	...
	if( !count ){
		...
		var arr_employee_num = fillArrayWithNumbers(RANDOM_MAX).shuffle().slice(0,count);
		// console.log('arr_employee_num', arr_employee_num)

		// arr_employee_num = arr_employee_num.slice(0,count);
		// console.log(arr_employee_num.slice(0,count).length);
